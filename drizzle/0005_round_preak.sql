...
ALTER TABLE "users" ALTER COLUMN "clerk_id" SET DATA TYPE text;--> statement-breakpoint
ALTER TABLE "videos" ALTER COLUMN "user_id" SET DATA TYPE text;--> statement-breakpoint
ALTER TABLE "videos" ALTER COLUMN "mux_asset_id" SET NOT NULL;--> statement-breakpoint
ALTER TABLE "videos" ALTER COLUMN "mux_status" SET NOT NULL;--> statement-breakpoint
ALTER TABLE "videos" ALTER COLUMN "mux_upload_id" SET NOT NULL;--> statement-breakpoint
